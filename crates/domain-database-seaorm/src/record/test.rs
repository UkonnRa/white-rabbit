...
use domain::account::command::{AccountCommand, AccountCommandCreate};
...
async fn setup_accounts(sess: &mut SeaOrmSession) -> (JournalId, AccountId, AccountId, AccountId) {
    ...
    let r1 = account_service
        ...
        .await
        .unwrap();
    let asset_id = find_account_created_id(&r1.events, "Cash");
    ...
    let r2 = account_service
        ...
        .await
        .unwrap();
    let expense_id = find_account_created_id(&r2.events, "Food");
    ...
    let r3 = account_service
        ...
        .await
        .unwrap();
    let equity_id = find_account_created_id(&r3.events, "Opening");
